...
#
# Taxonomia oficial de 28 blocos, identica bloco a bloco a
# VARIABLE_ID_RANGES/PARAMETER_ID_RANGES: "hydrate" foi
# substituido por "max_ht" (mesma faixa, 13000-13999);
# "costs" foi desmembrado em custo_budget/custo_forecast_bdgt/
# custo_forecast_real mais budget/forecast; "shared" foi
# realocado de 23000-23999 para 37000-37999.
EQUATION_ID_RANGES = {
